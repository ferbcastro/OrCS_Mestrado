...
typedef enum {
  ...
  XED_CHIP_EMERALD_RAPIDS,
  XED_CHIP_GRANITE_RAPIDS,
  XED_CHIP_DIAMOND_RAPIDS,
  XED_CHIP_SIERRA_FOREST,
  XED_CHIP_CLEARWATER_FOREST,
  XED_CHIP_ARROW_LAKE,
  XED_CHIP_LUNAR_LAKE,
  XED_CHIP_PANTHER_LAKE,
  XED_CHIP_FUTURE,
  XED_CHIP_ALL,
  XED_CHIP_LAST
} xed_chip_enum_t;
