...
int main(int argc, char* argv[])
{
    ...
    if (pid == 0)
    {
        ...
        std::cout << "Execve failed " << argv[1] << " " << argv[2] << " " << argv[3] << std::endl;
        return 1;
    }
    else
    {
    ...
    else
    {
        ...
        {
            std::cout << "Parent report: Child process failed. Status of the child process is " << WEXITSTATUS(siginfo.si_status)
                 << std::endl;
            return 6;
        }
        else
