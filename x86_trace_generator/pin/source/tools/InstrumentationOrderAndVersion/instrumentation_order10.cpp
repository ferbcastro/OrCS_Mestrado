...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "instrumentation_order10.out",
...
static VOID Trace(TRACE trace, VOID* v)
{
    ...
    if (TRACE_Address(trace) == RTN_Address(rtn))
    {
        ...
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "Trace instrumentation1", IARG_CALL_ORDER,
                       CALL_ORDER_FIRST + 3, IARG_END);
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "Trace instrumentation2", IARG_CALL_ORDER,
...
static VOID Ins(INS ins, VOID* v)
{
    ...
    {
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "Ins instrumentation1", IARG_CALL_ORDER,
                       CALL_ORDER_FIRST + 1, IARG_END);
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "Ins instrumentation2", IARG_CALL_ORDER,
...
static VOID Rtn(RTN rtn, VOID* v)
{
    ...
    INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "RTN instrumentation1", IARG_CALL_ORDER,
                   CALL_ORDER_FIRST + 7, IARG_END);
    INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "RTN instrumentation2", IARG_CALL_ORDER,
                   CALL_ORDER_FIRST + 6, IARG_END);
    RTN_Close(rtn);
}
...
static VOID Image(IMG img, VOID* v)
{
    ...
    INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "IMG instrumentation1", IARG_CALL_ORDER,
                   CALL_ORDER_FIRST + 5, IARG_END);
    INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(Emit), IARG_PTR, "IMG instrumentation2", IARG_CALL_ORDER,
                   CALL_ORDER_FIRST + 4, IARG_END);
    RTN_Close(rtn);
}
