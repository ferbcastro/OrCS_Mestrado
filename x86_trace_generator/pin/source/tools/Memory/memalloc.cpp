...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "memalloc.out", "specify memalloc file name");
...
#if defined(TARGET_WINDOWS) && __clang__
...
VOID Fini(INT32 code, VOID* v)
{
    ...
    char* ptr                    = NULL;
    unsigned int max_allocations = 1 << 31;
