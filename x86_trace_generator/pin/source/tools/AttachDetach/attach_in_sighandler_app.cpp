...
void SigUsr1Handler(int signum, siginfo_t* siginfo, void* uctxt)
{
    ...
    {
        std::cerr << "Unexpected xmm values in signal handler: " << std::hex << std::endl;
        std::cerr << "xmm1 = " << appContextXmm1 << ", Expected " << xmm1_app << std::endl;
        std::cerr << "xmm2 = " << appContextXmm2 << ", Expected " << xmm1_app << std::endl;
        std::cerr << "xmm3 = " << appContextXmm3 << ", Expected " << xmm1_app << std::endl;
        exit(-1);
    }
...
void ParseCommandLine(int argc, char* argv[], std::list< std::string >* pinArgs, unsigned int* testNo)
{
...
int TestRtSigframe()
{
    ...
    {
        std::cerr << "Unexpected xmm values after return from signal handler: " << std::hex << std::endl;
        std::cerr << "xmm1 = " << xmm1 << ", Expected " << xmm1_sig << std::endl;
        std::cerr << "xmm2 = " << xmm2 << ", Expected " << xmm2_sig << std::endl;
        std::cerr << "xmm3 = " << xmm3 << ", Expected " << xmm3_sig << std::endl;
        return -1;
    }
    std::cout << "All xmm values are correct" << std::endl;
...
int TestSigframe()
{
    ...
    {
        std::cerr << "Unexpected xmm values after return from signal handler: " << std::hex << std::endl;
        std::cerr << "xmm1 = " << xmm1 << ", Expected " << xmm1_app << std::endl;
        std::cerr << "xmm2 = " << xmm2 << ", Expected " << xmm2_app << std::endl;
        std::cerr << "xmm3 = " << xmm3 << ", Expected " << xmm3_app << std::endl;
        return -1;
    }
