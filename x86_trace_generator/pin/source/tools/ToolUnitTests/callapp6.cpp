...
{
    std::cout << " myBlue: Jitting Blue6()" << std::endl;
...
{
    std::cout << " myBar: Jitting Bar6()" << std::endl;
    ...
    std::cout << " myBar: Returned from Bar6(); res = " << res << std::endl;
...
{
    PROTO protoBar = PROTO_Allocate(PIN_PARG(int), CALLINGSTD_DEFAULT, "Bar6", PIN_PARG(int), PIN_PARG(int), PIN_PARG_END());

    PROTO protoBlue = PROTO_Allocate(PIN_PARG(int), CALLINGSTD_DEFAULT, "Blue6", PIN_PARG(int), PIN_PARG(int), PIN_PARG_END());
