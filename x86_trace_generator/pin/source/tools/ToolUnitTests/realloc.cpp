...
int main(int argc, char* argv[])
{
    ...
    std::cerr << "Malloc : " << std::hex << ptr1 << std::dec << std::endl;
    ...
    std::cerr << "Memalign : " << std::hex << ptr2 << std::dec << std::endl;
    ...
    std::cerr << "Memalign : " << std::hex << ptr3 << std::dec << std::endl;
    ...
    std::cerr << "Memalign : " << std::hex << ptr4 << std::dec << std::endl;
...
BOOL TestRealloc(void* ptr, size_t sz)
{
    ...
    ptr = tmp;
    std::cerr << "Realloc to larger size : " << std::hex << ptr << std::dec << std::endl;
    ...
    ptr = tmp;
    std::cerr << "Realloc to smaller size : " << std::hex << ptr << std::dec << std::endl;
    free(ptr);
