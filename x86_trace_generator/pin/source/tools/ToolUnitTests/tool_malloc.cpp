...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "tool_malloc.out", "specify output file name");

/* ===================================================================== */

INT32 Usage()
{
    std::cerr << "This tool allocate a record for each trace, and report the number of allocated bytes"
            "\n";
...
VOID Fini(INT32 code, VOID* v)
{
    ...
    TraceFile << alloc_count << std::endl;
    TraceFile.close();
}
