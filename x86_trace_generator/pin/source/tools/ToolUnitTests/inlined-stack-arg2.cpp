...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "inlined-stack-arg2.out", "output file");
...
INT32 Usage()
{
    std::cerr << "This tests if the stack arguments are optimized as expected"
            "\n";
