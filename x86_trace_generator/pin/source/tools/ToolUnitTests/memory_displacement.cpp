...
INT32 Usage()
{
    std::cerr << "This tool check the correctness of INS_MemoryDisplacement(INS ins) function, which return the displacement as a "
            "sign number"
         << std::endl;
    ...
    std::cerr << KNOB_BASE::StringKnobSummary() << std::endl; //   Print out a summary of all the knobs declare
