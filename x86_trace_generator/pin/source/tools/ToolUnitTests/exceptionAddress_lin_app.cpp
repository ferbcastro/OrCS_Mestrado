...
static void pinException() { std::cerr << "APP: in pinException" << std::endl; }

static void toolException() { std::cerr << "APP: in toolException" << std::endl; }

static int appException()
{
    std::cerr << "APP: in appException" << std::endl;
