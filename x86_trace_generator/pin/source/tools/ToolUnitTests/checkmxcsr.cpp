...
INT32 Usage()
{
    std::cerr << "This tool inserts an anlysis routine before fnop instructions." << std::endl;
    std::cerr << "this analysis routine changes mxcsr register and sets its value:" << std::endl;
    std::cerr << "It sets DMZ bits 0x40 and/or 0x20." << std::endl;
    std::cerr << "The corresponding application checks if (after fnop) the mxcsr register" << std::endl;
    std::cerr << "has changed or not." << std::endl;
    return -1;
}
...
{
    std::cout << "===============================================" << std::endl;
    std::cout << "Number of fnop: " << fnopCount << std::endl;
    std::cout << "===============================================" << std::endl;
}
