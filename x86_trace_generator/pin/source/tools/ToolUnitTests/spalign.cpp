...
static VOID InstrumentTrace(TRACE trace, VOID* v)
{
    ...
    switch (testNum++)
    {
        case 0:
            ...
            //
            TRACE_InsertCall(trace, IPOINT_BEFORE, MAKE_AFUNPTR(AtTraceOutOfLine), IARG_END);
            break;
        ...
        case 2:
            ...
            //
            TRACE_InsertCall(trace, IPOINT_BEFORE, MAKE_AFUNPTR(CheckSPAlign), IARG_END);
            break;
        ...
        case 4:
            ...
            //
            TRACE_InsertCall(trace, IPOINT_BEFORE, MAKE_AFUNPTR(AtTraceOutOfLine), IARG_CONTEXT, IARG_END);
            break;
