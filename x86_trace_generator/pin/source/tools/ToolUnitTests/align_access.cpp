...
KNOB< std::string > KnobOutput(KNOB_MODE_WRITEONCE, "pintool", "o", "align_check.out", "output file");
...
typedef std::vector< INS_INFO* > INFO_ARRAY;
...
VOID Fini(INT32 code, VOID* v)
{
    ...
    std::vector< INS_INFO* >::iterator iter = infoArray.begin();
