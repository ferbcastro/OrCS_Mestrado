...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "thenpredicated.out", "Output file");

/* ===================================================================== */

INT32 Usage()
{
    std::cerr << "This tool tests thenpredicated instrumentation" << std::endl;
...
{
    out << "Predicated true instructions " << predicatedTrueCount << std::endl;
    out.close();
}
