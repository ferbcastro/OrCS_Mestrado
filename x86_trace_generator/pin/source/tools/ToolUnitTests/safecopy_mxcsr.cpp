...
VOID SafeCopyTest()
{
    ...
    out << "SafeCopy (A): Entire buffer has been copied successfully." << std::endl;
    ...
    out << "SafeCopy (B): Accessible part of the buffer has been copied successfully." << std::endl;
    ...
    out << "SafeCopy (C): Inaccessible buffer has not been copied." << std::endl;
...
VOID SafeCopyTestInTrace()
{
    ...
    {
        first = FALSE;
        out << "Test SafeCopy in the trace analysis routine." << std::endl;
        SafeCopyTest();
    }
}
...
VOID Trace(TRACE trace, VOID* v)
{
    ...
    {
        first = FALSE;
        out << "Test SafeCopy in the trace instrumentation callback." << std::endl;
        SafeCopyTest();
    ...
    if (probeAddr != 0)
    {
        out << "Test SafeCopy in a region overwritten by probe." << std::endl;
        CHAR buffer[8];
...
VOID Fini(INT32 code, VOID* v) { out << "SafeCopy test completed." << std::endl; }
