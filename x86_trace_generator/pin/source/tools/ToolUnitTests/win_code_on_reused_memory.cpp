...
int main()
{
    ...
    // First
    {
        ...
        {
            std::cout << "Failed to commit memory at first" << std::endl;
            exit(0);
        }
        memcpy(address1, (const VOID*)Return10, functionSize1);
        FUNCTION_PROTO pReturn10 = (FUNCTION_PROTO)address1;
        std::cout << "First function return value = " << pReturn10() << std::endl;
    ...
    // Second
    {
        ...
        {
            std::cout << "Failed to commit memory at second" << std::endl;
            exit(0);
        }
        memcpy(address2, (const VOID*)Return20, functionSize2);
        FUNCTION_PROTO pReturn20 = (FUNCTION_PROTO)address2;
        std::cout << "Second function return value = " << pReturn20() << std::endl;
