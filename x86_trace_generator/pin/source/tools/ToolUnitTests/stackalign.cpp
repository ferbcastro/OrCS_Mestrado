...
// GCC 4.4 has more aggressive inliner, when it is inlined in main below
...
#if defined(TARGET_IA32E) && defined(TARGET_WINDOWS)
...
#if defined(TARGET_IA32E) || defined(TARGET_BSD)
...
{
    INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CheckAlign), IARG_ADDRINT, 1, IARG_ADDRINT, 2, IARG_ADDRINT, 3, IARG_ADDRINT,
                   4, IARG_ADDRINT, 5, IARG_ADDRINT, 6, IARG_ADDRINT, 7, IARG_ADDRINT, 8, IARG_ADDRINT, 9, IARG_ADDRINT, 10,
                   IARG_END);
}
