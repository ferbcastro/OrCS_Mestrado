...
VOID Ins(INS ins, VOID* v)
{
    ...
    if (INS_Opcode(ins) == XED_ICLASS_PUSH)
    {
        if (INS_OperandIsImmediate(ins, 0))
        {
            ...
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuPushValue), IARG_REG_VALUE, REG_STACK_PTR, IARG_ADDRINT, value,
        ...
        else if (INS_OperandIsReg(ins, 0))
        {
            ...
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuPushValue), IARG_REG_VALUE, REG_STACK_PTR, IARG_REG_VALUE, reg,
                           IARG_RETURN_REGS, REG_STACK_PTR, IARG_END);
        ...
        {
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuPushMem), IARG_REG_VALUE, REG_STACK_PTR, IARG_MEMORYREAD_EA,
                           IARG_RETURN_REGS, REG_STACK_PTR, IARG_END);
    ...
    else if (INS_Opcode(ins) == XED_ICLASS_POP)
    {
        ...
        {
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuPopReg), IARG_REG_VALUE, REG_STACK_PTR, IARG_REG_REFERENCE,
        ...
        {
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuPopMem), IARG_REG_VALUE, REG_STACK_PTR, IARG_MEMORYWRITE_EA,
                           IARG_RETURN_REGS, REG_STACK_PTR, IARG_END);
    ...
    {
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuLeave), IARG_REG_VALUE, REG_STACK_PTR, IARG_REG_REFERENCE, REG_GBP,
                       IARG_RETURN_REGS, REG_STACK_PTR, IARG_END);
    ...
    {
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuCall), IARG_ADDRINT, INS_NextAddress(ins), IARG_BRANCH_TARGET_ADDR,
    ...
    else if (INS_IsRet(ins))
    {
        ...
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuRet), IARG_CALL_ORDER, CALL_ORDER_FIRST, IARG_REG_REFERENCE,
                       REG_STACK_PTR, IARG_ADDRINT, (ADDRINT)imm, IARG_RETURN_REGS, scratchReg, IARG_END);
    ...
    else if (INS_IsIndirectControlFlow(ins))
    {
        ...
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(EmuIndJmp), IARG_BRANCH_TARGET_ADDR, IARG_RETURN_REGS, scratchReg,
                       IARG_END);
