...
VOID Instruction(INS ins, VOID* v)
{
    for (REG reg = REG_XMM_BASE; reg <= REG_XMM_LAST; reg = static_cast< REG >((static_cast< INT32 >(reg) + 1)))
    {
        ...
        {
            INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(TestXmm), IARG_INST_PTR, IARG_REG_REFERENCE, reg, IARG_REG_REFERENCE,
        ...
        {
            INS_InsertCall(ins, IPOINT_AFTER, MAKE_AFUNPTR(TestXmm), IARG_INST_PTR, IARG_REG_REFERENCE, reg, IARG_REG_REFERENCE,
