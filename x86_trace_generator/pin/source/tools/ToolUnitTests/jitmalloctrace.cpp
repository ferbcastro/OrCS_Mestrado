...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "jitmalloctrace.outfile", "specify trace file name");
...
VOID* Jit_Malloc_IA32(CONTEXT* context, AFUNPTR orgFuncptr, size_t size)
{
    ...
    TraceFile << "malloc(" << size << ") returns " << ret << std::endl;
    return ret;
}
