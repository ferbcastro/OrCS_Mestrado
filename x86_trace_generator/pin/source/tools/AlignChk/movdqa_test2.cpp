...
VOID Instruction(INS ins, VOID* v)
{
    ...
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)DoXmm, IARG_REG_REFERENCE, LEVEL_BASE::REG_EAX, IARG_END);
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)DoXmm, IARG_REG_REFERENCE, LEVEL_BASE::REG_EAX, IARG_UINT32, 1, IARG_END);
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)DoXmm, IARG_REG_REFERENCE, LEVEL_BASE::REG_EAX, IARG_UINT32, 1, IARG_UINT32, 2,
                   IARG_END);
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)DoXmm, IARG_REG_REFERENCE, LEVEL_BASE::REG_EAX, IARG_UINT32, 1, IARG_UINT32, 2,
                   IARG_UINT32, 3, IARG_END);
}
