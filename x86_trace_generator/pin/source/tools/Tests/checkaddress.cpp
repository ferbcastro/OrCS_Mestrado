...
VOID Instruction(INS ins, VOID* v)
{
    ...
    {
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CaptureEaAndValue), IARG_MEMORYREAD_EA, IARG_END);
        INS_InsertCall(ins, IPOINT_AFTER, MAKE_AFUNPTR(TestValue), IARG_INST_PTR, IARG_REG_VALUE, INS_RegW(ins, 0), IARG_END);
    }
}
