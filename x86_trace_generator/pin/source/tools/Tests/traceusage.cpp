...
typedef std::map< ADDRINT, BBL_INFO > BBL_MAP;
...
std::ofstream OutFile("traceusage.trace");
...
/*
 Print bbl exit info
*/
VOID PrintBblExit(std::pair< const ADDRINT, BBL_INFO > bbl_info)
{
    OutFile << std::hex << "0x" << bbl_info.first << "\t" << std::setw(5) << std::dec << bbl_info.second.exec_cnt << "\t" << std::setw(5) << std::dec
            << bbl_info.second.ins_cnt << "\t" << std::setw(5) << std::dec << bbl_info.second.bbl_exit_cnt << "\t" << std::setw(5) << std::dec
            << bbl_info.second.code_size << "\t" << std::setw(5) << std::dec << bbl_info.second.accum_code_size << "\t" << std::endl;
}
...
/*
 Print a trace
*/
VOID PrintTrace(std::pair< const ADDRINT, TRACE_INFO > trace_info)
{
    /* Trace information */
    OutFile << "==================================================================" << std::endl;
    OutFile << "Trace:"
    ...
    OutFile << std::hex << "0x" << trace_info.first << "\t" << std::setw(5) << std::dec << trace_info.second.exec_cnt << "\t" << std::setw(5) << std::dec
            << trace_info.second.bbl_cnt << "\t" << std::setw(5) << std::dec << trace_info.second.ins_cnt << "\t" << std::endl
            << std::endl;
