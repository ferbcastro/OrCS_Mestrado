...
using WINDOWS::CONTEXT;
using WINDOWS::EXCEPTION_RECORD;
using WINDOWS::LPEXCEPTION_POINTERS;
using WINDOWS::UINT32;
using WINDOWS::UINT8;
using WINDOWS::ULONG_PTR;
...
extern "C" unsigned int GetInstructionLenAndDisasm(unsigned char* ip, std::string* str);
