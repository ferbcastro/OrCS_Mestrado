...
VOID Instruction(INS ins, VOID* v)
{
    ...
    {
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CaptureEspBefore), IARG_REG_VALUE, REG_STACK_PTR, IARG_END);
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CaptureRefWithReturnReg), IARG_REG_REFERENCE, REG_GAX,
                       IARG_REG_CONST_REFERENCE, REG_GAX, IARG_RETURN_REGS, REG_GAX, IARG_END);
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CaptureRef), IARG_REG_REFERENCE, REG_GAX, IARG_REG_CONST_REFERENCE,
                       REG_GAX, IARG_END);
        INS_InsertCall(ins, IPOINT_BEFORE, MAKE_AFUNPTR(CaptureEspAfter), IARG_REG_VALUE, REG_STACK_PTR, IARG_END);
    }
}
