...
{
    RTN_Open(rtn);
    RTN_InsertCall(rtn, IPOINT_BEFORE, MAKE_AFUNPTR(Inline), IARG_END);
    RTN_Close(rtn);
}
...
{
    RTN_Open(rtn);
    RTN_InsertCall(rtn, IPOINT_BEFORE, MAKE_AFUNPTR(NoBridge), IARG_END);
    RTN_Close(rtn);
}
...
{
    RTN_Open(rtn);
    RTN_InsertCall(rtn, IPOINT_BEFORE, MAKE_AFUNPTR(Bridge), IARG_BRIDGE, IARG_END);
    RTN_Close(rtn);
}
