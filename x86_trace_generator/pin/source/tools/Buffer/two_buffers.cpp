 ...
 */
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "two_buffers.out", "output file");
...
int main(int argc, char* argv[])
{
    ...
    {
        std::cerr << "Error allocating initial buffer 1" << std::endl;
        return 1;
    }
    ...
    {
        std::cerr << "Error allocating initial buffer 2" << std::endl;
        return 1;
    }
    ...
    if (!outfile)
    {
        std::cerr << "Couldn't open two_buffers.out" << std::endl;
        return 1;
    }
