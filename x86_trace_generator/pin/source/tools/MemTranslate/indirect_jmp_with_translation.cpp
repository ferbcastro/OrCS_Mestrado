...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "indirect_jmp_translation.out",
...
VOID Instruction(INS ins, VOID* v)
{
    ...
    {
        OutFile << "Instrumenting at " << std::hex << INS_Address(ins) << " " << INS_Disassemble(ins).c_str() << std::endl;
...
INT32 Usage()
{
    std::cerr << "This tool tests memory address translation for indirect call" << std::endl;
