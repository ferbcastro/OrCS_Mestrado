...
INT32 Usage()
{
    std::cerr << "This test checks the correctness of IARG_CHECK_INLINE usage on analysis routine." << std::endl
         << "IARG_CHECK_INLINE marks analysis routine as expected by the tool to be inlined by Pin" << std::endl;
    return -1;
}
