...
INT32 Usage()
{
    std::cerr << "This Pin tool simulates correct usage of instrumenting with IARG_BRANCH_TAKEN" << std::endl;
    std::cerr << "It counts the number of times this argument was passed with value 1 and prints it" << std::endl;
