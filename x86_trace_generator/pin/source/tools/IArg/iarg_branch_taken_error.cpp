...
VOID Fini(INT32 code, VOID* v) { std::cout << "end of run: taken = " << taken_count << std::endl; }
...
INT32 Usage()
{
    std::cerr << "This Pin tool presents wrong usage of instrumenting with IARG_BRANCH_TAKEN" << std::endl;
    std::cerr << "When it is applied on applications that have RTM instructions, it will cause an error" << std::endl;
