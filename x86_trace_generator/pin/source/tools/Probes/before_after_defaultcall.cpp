...
STATIC VOID ExitWithError(IMG img, RTN rtn)
{
    ...
    for (SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
    {
        ...
        if (undFuncName == "DefaultCallFunctionToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE,
                                         protoOfDefaultCallFunction1ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting calls after DefaultCallFunctionToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
                    ExitWithError(img, rtn);
                }
                if (RTN_InsertCallProbed(rtn, IPOINT_BEFORE, AFUNPTR(Before), IARG_PROTOTYPE,
                                         protoOfDefaultCallFunction1ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting calls before DefaultCallFunctionToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "DefaultCallFunction2ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before DefaultCallFunction2ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after DefaultCallFunction2ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "DefaultCallFunction3ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after DefaultCallFunction3ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "DefaultCallFunction4ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after DefaultCallFunction4ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_BEFORE, AFUNPTR(BeforeWithParams), IARG_PROTOTYPE,
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before DefaultCallFunction4ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "DefaultCallFunction5ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(AfterWithParams), IARG_PROTOTYPE,
                                         protoOfDefaultCallFunction5ToBeReplacedByPin, IARG_REG_VALUE, REG_GAX, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after DefaultCallFunction5ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before DefaultCallFunction5ToBeReplacedByPin() in %s at address %p\n",
                           IMG_Name(img).c_str(), (VOID*)RTN_Address(rtn));
                }
                else
                {
