...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "probe7.outfile", "specify file name");
...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    RTN rtn = RTN_FindByName(img, "JmpRelAt0");
    if (RTN_Valid(rtn))
    {
        ...
        TraceFile << "Inserted probe for JmpRelAt0:" << IMG_Name(img) << std::endl;
    }
