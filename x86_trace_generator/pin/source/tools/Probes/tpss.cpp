...
typedef WINDOWS::HMODULE(WINAPI* tpss_load_library_w_call_t)(WINDOWS::LPCWSTR lpLibFileName);
...
WINDOWS::HMODULE WINAPI tpss_LoadLibraryW_ver0(WINDOWS::LPCWSTR lpLibFileName)
{
...
{
    WINDOWS::LoadLibraryW(L"dbghelp.dll");
