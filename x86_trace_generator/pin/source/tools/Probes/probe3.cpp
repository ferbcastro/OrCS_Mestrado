...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "probe3.outfile", "specify file name");
...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    if (RTN_Valid(rtn))
    {
        ...
        TraceFile << "Inserted probe for call_function:" << IMG_Name(img) << std::endl;
    }
