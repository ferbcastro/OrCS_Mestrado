...
void SigUsr1Handler(int sig) { std::cerr << expected << "Caught signal SIGUSR1" << std::endl; }

void SigUsr2Handler(int sig) { std::cerr << expected << "Caught signal SIGUSR2" << std::endl; }
