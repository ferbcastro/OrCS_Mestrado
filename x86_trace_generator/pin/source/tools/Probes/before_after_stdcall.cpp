    ...
    for (SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
    {
        ...
        if (undFuncName == "StdCallFunctionToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                                         ...
                                         protoOfStdCallFunction1ToBeReplacedByPin, IARG_END))
                {
                    ...
                    printf("Inserting calls after StdCallFunctionToBeReplacedByPin() in %s at address %x\n",
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting calls before StdCallFunctionToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "StdCallFunction2ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after StdCallFunction2ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "StdCallFunction3ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE,
                                         protoOfStdCallFunction3ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
        ...
        else if (undFuncName == "StdCallFunction4ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE,
                                         protoOfStdCallFunction4ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before StdCallFunction4ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "StdCallFunction5ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before StdCallFunction5ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
