    ...
    for (SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
    {
        ...
        if (undFuncName == "FastCallFunctionToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                                         ...
                                         protoOfFastCallFunction1ToBeReplacedByPin, IARG_END))
                {
                    ...
                    printf("Inserting calls after FastCallFunctionToBeReplacedByPin() in %s at address %x\n",
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting calls before FastCallFunctionToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "FastCallFunction2ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call after FastCallFunction2ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "FastCallFunction3ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE,
                                         protoOfFastCallFunction3ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
        ...
        else if (undFuncName == "FastCallFunction4ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE,
                                         protoOfFastCallFunction4ToBeReplacedByPin, IARG_END))
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before FastCallFunction4ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
        ...
        else if (undFuncName == "FastCallFunction5ToBeReplacedByPin")
        {
            ...
            if (RTN_Valid(rtn))
            {
                ...
                {
                    ASSERTX(RTN_IsSafeForProbedInsertion(rtn));
                    printf("Inserting call before FastCallFunction5ToBeReplacedByPin() in %s at address %x\n",
                           IMG_Name(img).c_str(), RTN_Address(rtn));
                }
                else
                {
