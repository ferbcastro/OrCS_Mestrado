...
VOID Before(INT32 arg0, INT32 arg1, INT32 arg2, INT32 arg3, INT32 arg4, INT32 arg5, INT32 arg6, INT32 arg7, INT32 arg8,
            INT32 arg9)
{
    std::cout << "Before: arguments = ( " << arg0 << ", " << arg1 << ", " << arg2 << ", " << arg3 << ", " << arg4 << ", " << arg5
        ...
        for (SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
        {
            ...
            if (undFuncName == "FastBar10")
            {
                ...
                if (RTN_Valid(rtn))
                {
                    ...
                    if (RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After), IARG_PROTOTYPE, proto, IARG_REG_VALUE, REG_GAX,
                                             IARG_END) &&
                        RTN_InsertCallProbed(rtn, IPOINT_AFTER, AFUNPTR(After0), IARG_PROTOTYPE, proto, IARG_UINT32, 1,
                                             IARG_UINT32, 2, IARG_UINT32, 3, IARG_UINT32, 4, IARG_UINT32, 5, IARG_UINT32, 6,
                                             IARG_UINT32, 7, IARG_UINT32, 8, IARG_UINT32, 9, IARG_UINT32, 0, IARG_END) &&
                                             ...
                                             IARG_FUNCARG_ENTRYPOINT_VALUE, 8, IARG_FUNCARG_ENTRYPOINT_VALUE, 9, IARG_END))
                    {
                        ...
                        std::cout << "Inserting calls before/after FastBar10 in " << IMG_Name(img) << std::endl;
                    }
                    else
                    {
                    ...
                    std::cout << "Cannot find FastBar10" << std::endl;
            }
        }
    }
}
