...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "probe8.outfile", "specify file name");
...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    RTN rtn = RTN_FindByName(img, C_MANGLE("bad_jump"));
    ...
    if (RTN_Valid(rtn))
    {
        ...
        TraceFile << "Inserted probe for bad_jump" << IMG_Name(img) << std::endl;
    }
