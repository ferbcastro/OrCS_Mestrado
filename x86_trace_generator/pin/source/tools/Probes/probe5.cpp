...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "probe5.outfile", "specify file name");
...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    if (RTN_Valid(rtn))
    {
        ...
        TraceFile << "Inserted probe for call_nothing:" << IMG_Name(img) << std::endl;
    }
