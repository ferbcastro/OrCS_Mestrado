...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    if (RTN_Valid(iprelImmRtn))
    {
        ...
        std::cerr << "Inserted probe for iprel_imm:" << IMG_Name(img) << std::endl;
    }
    ...
    if (RTN_Valid(iprelRegRtn))
    {
        ...
        std::cerr << "Inserted probe for iprel_reg:" << IMG_Name(img) << std::endl;
    }
    ...
    if (RTN_Valid(regIprelRtn))
    {
        ...
        std::cerr << "Inserted probe for reg_iprel:" << IMG_Name(img) << std::endl;
    }
}
