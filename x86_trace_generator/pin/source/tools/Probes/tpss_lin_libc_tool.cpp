...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "tpss_lin_libc.txt", "specify tool log file name");
...
INT32 Usage()
{
    std::cerr << "This tool mimics the behavior of TPSS on Linux by adding probes to various libc functions." << std::endl;
...
bool is_GLIBC2_24_or_newer(IMG img)
{
    ...
    {
        return (std::string("libc-2.24.so") == basename(path));
    }
    return false;
}
...
void ImgLoad(IMG img, VOID_PTR v)
{
    ...
    if ((IMG_Name(img).find("libc.so") != std::string::npos) || (IMG_Name(img).find("LIBC.SO") != std::string::npos) ||
        (IMG_Name(img).find("LIBC.so") != std::string::npos))
    {
        RTN rtnsleep = RTN_FindByName(img, "sleep");
        if (RTN_Valid(rtnsleep) && RTN_IsSafeForProbedReplacement(rtnsleep))
        {
            OutFile << CurrentTime() << "Inserting probe for sleep at " << RTN_Address(rtnsleep) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for socket at " << RTN_Address(rtnsocket) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for shutdown at " << RTN_Address(rtnshutdown) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for select at " << RTN_Address(rtnselect) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for poll at " << RTN_Address(rtnpoll) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pselect at " << RTN_Address(rtnpselect) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for accept at " << RTN_Address(rtnaccept) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for connect at " << RTN_Address(rtnconnect) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for recv at " << RTN_Address(rtnrecv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for recvfrom at " << RTN_Address(rtnrecvfrom) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for send at " << RTN_Address(rtnsend) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sendto at " << RTN_Address(rtnsendto) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getwc at " << RTN_Address(rtngetwc) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getw at " << RTN_Address(rtngetw) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for _IO_getc at " << RTN_Address(rtn_IO_getc) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getchar at " << RTN_Address(rtngetchar) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getwchar at " << RTN_Address(rtngetwchar) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for gets at " << RTN_Address(rtngets) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fgetc at " << RTN_Address(rtnfgetc) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fgetwc at " << RTN_Address(rtnfgetwc) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fgets at " << RTN_Address(rtnfgets) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fgetws at " << RTN_Address(rtnfgetws) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fread at " << RTN_Address(rtnfread) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fwrite at " << RTN_Address(rtnfwrite) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pipe at " << RTN_Address(rtnpipe) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for read at " << RTN_Address(rtnread) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for write at " << RTN_Address(rtnwrite) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for open at " << RTN_Address(rtnopen) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fopen at " << RTN_Address(rtnfopen) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fdopen at " << RTN_Address(rtnfdopen) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for close at " << RTN_Address(rtnclose) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fclose at " << RTN_Address(rtnfclose) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for callrpc at " << RTN_Address(rtncallrpc) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for clnt_broadcast at " << RTN_Address(rtnclnt_broadcast) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for clntudp_create at " << RTN_Address(rtnclntudp_create) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for clntudp_bufcreate at " << RTN_Address(rtnclntudp_bufcreate) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pmap_getmaps at " << RTN_Address(rtnpmap_getmaps) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pmap_getport at " << RTN_Address(rtnpmap_getport) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pmap_rmtcall at " << RTN_Address(rtnpmap_rmtcall) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pmap_set at " << RTN_Address(rtnpmap_set) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for clntraw_create at " << RTN_Address(rtnclntraw_create) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svc_run at " << RTN_Address(rtnsvc_run) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svc_sendreply at " << RTN_Address(rtnsvc_sendreply) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svcraw_create at " << RTN_Address(rtnsvcraw_create) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svctcp_create at " << RTN_Address(rtnsvctcp_create) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svcudp_bufcreate at " << RTN_Address(rtnsvcudp_bufcreate) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for svcudp_create at " << RTN_Address(rtnsvcudp_create) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for abort at " << RTN_Address(rtnabort) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for _exit at " << RTN_Address(rtn_exit) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for nanosleep at " << RTN_Address(rtnnanosleep) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for signal at " << RTN_Address(rtnsignal) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigprocmask at " << RTN_Address(rtnsigprocmask) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigpending at " << RTN_Address(rtnsigpending) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigaction at " << RTN_Address(rtnsigaction) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for setitimer at " << RTN_Address(rtnsetitimer) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for exit at " << RTN_Address(rtnexit) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for dl_iterate_phdr at " << RTN_Address(rtndl_iterate_phdr) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for system at " << RTN_Address(rtnsystem) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for alarm at " << RTN_Address(rtnalarm) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for recvmsg at " << RTN_Address(rtnrecvmsg) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sendmsg at " << RTN_Address(rtnsendmsg) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for pause at " << RTN_Address(rtnpause) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigtimedwait at " << RTN_Address(rtnsigtimedwait) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigwaitinfo at " << RTN_Address(rtnsigwaitinfo) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for epoll_wait at " << RTN_Address(rtnepoll_wait) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for ppoll at " << RTN_Address(rtnppoll) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for msgsnd at " << RTN_Address(rtnmsgsnd) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for msgrcv at " << RTN_Address(rtnmsgrcv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for semop at " << RTN_Address(rtnsemop) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for semtimedop at " << RTN_Address(rtnsemtimedop) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for usleep at " << RTN_Address(rtnusleep) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for ualarm at " << RTN_Address(rtnualarm) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getitimer at " << RTN_Address(rtngetitimer) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigwait at " << RTN_Address(rtnsigwait) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for msgget at " << RTN_Address(rtnmsgget) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for semget at " << RTN_Address(rtnsemget) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for wait at " << RTN_Address(rtnwait) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for waitpid at " << RTN_Address(rtnwaitpid) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for waitid at " << RTN_Address(rtnwaitid) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for wait3 at " << RTN_Address(rtnwait3) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for wait4 at " << RTN_Address(rtnwait4) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for readv at " << RTN_Address(rtnreadv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for writev at " << RTN_Address(rtnwritev) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for flockfile at " << RTN_Address(rtnflockfile) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for funlockfile at " << RTN_Address(rtnfunlockfile) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for lockf at " << RTN_Address(rtnlockf) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for setenv at " << RTN_Address(rtnsetenv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for unsetenv at " << RTN_Address(rtnunsetenv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getenv at " << RTN_Address(rtngetenv) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for perror at " << RTN_Address(rtnperror) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for mmap at " << RTN_Address(rtnmmap) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for munmap at " << RTN_Address(rtnmunmap) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fileno at " << RTN_Address(rtnfileno) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getpid at " << RTN_Address(rtngetpid) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for getppid at " << RTN_Address(rtngetppid) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for memset at " << RTN_Address(rtnmemset) << std::endl;
            OutFile.flush();
        ...
        if (RTN_Valid(rtnmemcpy) && RTN_IsSafeForProbedReplacement(rtnmemcpy))
        {
            ...
            {
                OutFile << CurrentTime() << "Inserting probe for memcpy at " << RTN_Address(rtnmemcpy) << std::endl;
                OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for access at " << RTN_Address(rtnaccess) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for lseek at " << RTN_Address(rtnlseek) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for lseek64 at " << RTN_Address(rtnlseek64) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for fdatasync at " << RTN_Address(rtnfdatasync) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for unlink at " << RTN_Address(rtnunlink) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strlen at " << RTN_Address(rtnstrlen) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for wcslen at " << RTN_Address(rtnwcslen) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strcpy at " << RTN_Address(rtnstrcpy) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strncpy at " << RTN_Address(rtnstrncpy) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strcat at " << RTN_Address(rtnstrcat) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strstr at " << RTN_Address(rtnstrstr) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strchr0 at " << RTN_Address(rtnstrchr0) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strrchr at " << RTN_Address(rtnstrrchr) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strcmp at " << RTN_Address(rtnstrcmp) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strncmp at " << RTN_Address(rtnstrncmp) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigaddset at " << RTN_Address(rtnsigaddset) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigdelset at " << RTN_Address(rtnsigdelset) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigismember at " << RTN_Address(rtnsigismember) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for strerror at " << RTN_Address(rtnstrerror) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for bind at " << RTN_Address(rtnbind) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for listen at " << RTN_Address(rtnlisten) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for uname at " << RTN_Address(rtnuname) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for gethostname at " << RTN_Address(rtngethostname) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for kill at " << RTN_Address(rtnkill) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sched_yield at " << RTN_Address(rtnsched_yield) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for timer_settime at " << RTN_Address(rtntimer_settime) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for sigaltstack at " << RTN_Address(rtnsigaltstack) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for ioctl at " << RTN_Address(rtnioctl) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for flock at " << RTN_Address(rtnflock) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for __errno_location at " << RTN_Address(rtn__errno_location) << std::endl;
            OutFile.flush();
        ...
        {
            OutFile << CurrentTime() << "Inserting probe for syscall at " << RTN_Address(rtnsyscall) << std::endl;
            OutFile.flush();
