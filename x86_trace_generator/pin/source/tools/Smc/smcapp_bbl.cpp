 ...
 * The function copies "bar" std::string into the specified buffer. If in-BBL SMC
 * is not handled, the output std::string is "foo".
...
int main(int argc, char* argv[])
{
    ...
    std::cerr << "foo2bar: Success" << std::endl;
    return 0;
}
