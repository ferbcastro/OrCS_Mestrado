...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "pic_image.out", "specify file name");
...
INT32 Usage()
{
    std::cerr << "This tool retrieves the first instruction of loaded image" << std::endl
              << "by using IMG_EntryAddress API. Address is absolute, regardless of image type (e.g. PIE)" << std::endl;
