...
typedef std::map< ADDRINT, MemRange, std::less< ADDRINT > > LoadedImagesMap;
...
VOID ImageLoad(IMG img, VOID* v)
{
    ...
    const std::pair< const ADDRINT, MemRange >& newpair = std::make_pair(IMG_LowAddress(img), memRange);
