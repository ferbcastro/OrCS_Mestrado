...
/* ===================================================================== */
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "", "specify file name for the tool's output");
...
INT32 Usage()
{
    std::cerr << "This tool asserts that the return value of the RCX register" << std::endl
         << "after a syscall is exited, is the address of the instruction" << std::endl
         << "right after the syscall" << std::endl
         << std::endl;
