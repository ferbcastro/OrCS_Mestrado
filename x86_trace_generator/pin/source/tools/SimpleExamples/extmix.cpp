...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "extmix.out", "specify profile file name");
...
INT32 Usage()
{
    std::cerr << "This pin tool computes static and  dynamic instruction family (=extension) mix profile\n"
            "\n";
