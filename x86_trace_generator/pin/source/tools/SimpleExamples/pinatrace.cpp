...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "pinatrace.out", "specify trace file name");
...
static INT32 Usage()
{
    std::cerr << "This tool produces a memory address trace.\n"
...
{
    TraceFile << ip << ": " << r << " " << std::setw(2 + 2 * sizeof(ADDRINT)) << addr << " " << std::dec << std::setw(2) << size << " " << std::hex
              << std::setw(2 + 2 * sizeof(ADDRINT));
