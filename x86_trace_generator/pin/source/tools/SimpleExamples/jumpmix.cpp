...
KNOB< std::string > KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool", "o", "jumpmix.out", "specify profile file name");
...
static INT32 Usage()
{
    std::cerr << "This pin tool collects a profile of jump/branch/call instructions for an application\n";
...
#define OUT(n, a, b) *out << n << " " << a << std::setw(16) << CountSeen.b << " " << std::setw(16) << CountTaken.b << std::endl
...
VOID Fini(int n, void* v)
{
    ...
    *out << "4000 *total " << std::setw(16) << CountSeen.Total() << " " << std::setw(16) << CountTaken.Total() << std::endl;
