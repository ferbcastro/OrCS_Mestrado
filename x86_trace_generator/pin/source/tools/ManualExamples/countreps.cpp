...
static KNOB< std::string > KnobOutput(KNOB_MODE_WRITEONCE, "pintool", "o", "countreps.out", "output file");
...
INT32 Usage()
{
    std::cerr << "This tool demonstrates how to optimize common REP cases, " << std::endl;
    std::cerr << "where the repeat count is known at the start of the REP " << std::endl;
    std::cerr << "instruction execution." << std::endl;
