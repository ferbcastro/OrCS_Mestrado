...
// thread cancel is not supported in bionic.
void CancelThread(TidType tid) { ErrorExit(RES_CANCEL_FAILED); }
...
// thread cancel is not supported in bionic.
void EnterSafeCancellationPoint() { ErrorExit(RES_CANCEL_FAILED); }
